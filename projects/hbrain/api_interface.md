...
````
{
    ...
    result: [
        {
            id: "57c939affdcdad190ba67c94",
            tags: ["新闻", "党参", "党参价格", "党参行情"],
            "claims": [
                {'p': '标题', 'o': '9月7日甘肃渭源党参行情继续疲软'}
                {'p': '作者', 'o': '兰菲'}
                {'p': '时间', 'o': '2016-09-07'}
                {'p': '正文', 'o': '甘肃渭源市场上党参上货量在200吨左右，跟上集持平，成交量 估计在20%-30%，整体走动疲软，成交价格有所下滑，今日成交价格下滑6-10元/kg，药厂货价格58元左右，中条成交价格64元左右， 大中条好货价格76元左右。  '}
            ],
        ...
        },
        {
            ...
            "claims": [
                ...
                {'p': '来源', 'o': '药通网'}
                {'p': '市场', 'o': '亳州'}
                {'p': '时间', 'o': '2016-08-30 10:49:21'}
                {'p': '正文', 'o': '党参近阶段产地货源走销缓慢，价稳中略有下滑；市场近日虽议论商家较多，但货源实际成交量不大，价格略显疲软，现小条散把货要价52元，穿条货60元；中条70-75元。'}
            ],
