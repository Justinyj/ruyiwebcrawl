...
设计说明
* 表示出发点为 RSS https://en.wikipedia.org/wiki/RSS
````
...
````
* 进阶表示参考 http://dev.iptc.org/rNews-1-Introduction-to-rNews
 
参数说明
* tags 会包括识别出来的实体
* "摘要" 新闻中的第一句话即可。 "正文"提取复杂度太高，本期不要强求（另外这样也可以利用搜索引擎结果直接转换）
* "链接" 就是 source.url，但这样有利于匹配
* "日期" 采用新闻标记的日期，optional, 不一定能抽取得出来， 
* "来源" 信息来源的简单名称，optional, 不一定能抽取得出来， 可以考虑采用域名到来源名称的人工映射支持
    ...
    result: [
        {
            ...
            tags: ["新闻", "党参", "价格", "市场"],
            "claims": [
                {'p': '标题', 'o': '9月7日甘肃渭源党参行情继续疲软'},
                {'p': '摘要', 'o': '甘肃渭源市场上党参上货量在200吨左右，跟上集持平，成交量 估计在20%-30%，整体走动疲软，成交价格有所下滑'},
                {'p': '链接', 'o': 'http://www.kmzyw.com.cn/pages/channel_11100/1160907/11100.1473229995000.5761.shtml'},
                {'p': '日期', 'o': '2016-09-07'},
        ...
        },
        {
            ...
            "claims": [
                {'p': '标题', 'o': '党参价格略显疲软'},
                {'p': '摘要', 'o' '党参近阶段产地货源走销缓慢，价稳中略有下滑；市场近日虽议论商家较多，但货源实际成交量不大，价格略显疲软'},
                {'p': '链接', 'o': 'http://www.yt1998.com/minute--396615--1.html'},
                {'p': '日期', 'o': '2016-08-30'},
            ...
            "deletedTime": "",
            "source": { 
                "url": "http://www.yt1998.com/minute--396615--1.html",
                "domain": "www.yt1998.com",
                "trackingId": "123890128sadfhsoaiao8",
                "confidence": "0.8"
            }
