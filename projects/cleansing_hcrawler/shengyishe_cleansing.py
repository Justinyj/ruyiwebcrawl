...
class Shengyishecleansing(HpriceCleansing):
    def parse_single_item(self, item):
        item_suit_schema = {
                    'id' : item[u'name'] + '_' + item[u'报价类型'] + '_' + item[u'报价机构'] + '_' if u'等级' in item[u'详细信息'] else '' + item[u'详细信息'][u'等级'] if u'等级' in item[u'详细信息'] else '' + '_' + item[u'发布时间'],
                    'name' : item[u'name'] + '_' + item[u'报价类型'] + '_' + item[u'报价机构'] + '_' if u'等级' in item[u'详细信息'] else '' + item[u'详细信息'][u'等级'] if u'等级' in item[u'详细信息'] else '',                         # 品种
                    'productGrade' : item[u'详细信息'][u'等级'] if u'等级' in item[u'详细信息'] else None,
