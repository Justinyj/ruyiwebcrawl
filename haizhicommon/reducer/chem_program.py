...
def save_bucket(bucketname, savepath):
    ...
    with open(wfname, 'w') as fd:
        ...
        for i in bucket.objects.all():
            ...
            if count & 4095 == 0:
                print(count)
    os.system('eval `ssh-agent -s`; chmod 600 /home/admin/.ssh/crawl-tokyo.pem; ssh-add /home/admin/.ssh/crawl-tokyo.pem; scp -o StrictHostKeyChecking=no {} admin@172.31.19.253:/data/chem/'.format(wfname))
